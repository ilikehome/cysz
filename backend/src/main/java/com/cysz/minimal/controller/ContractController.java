...
public class ContractController {
    ...
    public Result<Long> createContract(@RequestBody ContractCreateDTO dto) {
        ...
        System.out.println("业态字段值: " + dto.getBusinessFormat());
        System.out.println("业态字段是否为空: " + (dto.getBusinessFormat() == null || dto.getBusinessFormat().trim().isEmpty()));
        ...
        try {
            ...
            // 检查合同编号是否已存在
            try {
                String checkSql = "SELECT COUNT(*) FROM contract WHERE contract_no = ?";
            ...
            System.out.println("准备插入的业态值: '" + dto.getBusinessFormat() + "'");
            System.out.println("SQL参数列表:");
            System.out.println("1. contract_no: " + dto.getContractNo());
            System.out.println("11. business_format: " + dto.getBusinessFormat());
    ...
    public static class ContractCreateDTO {
        ...
        public String toString() {
            return "ContractCreateDTO{" +
                    ...
                    ", depositLatestDate=" + depositLatestDate +
                    ", feeCompany='" + feeCompany + '\'' +
                    ", rentMode='" + rentMode + '\'' +
                    ", rentPeriodSetting='" + rentPeriodSetting + '\'' +
                    ", lateFeeRule='" + lateFeeRule + '\'' +
                    ", paymentAccount='" + paymentAccount + '\'' +
                    ", paymentFrequency='" + paymentFrequency + '\'' +
                    ", latestPaymentDay=" + latestPaymentDay +
                    ", firstPaymentLatestDate=" + firstPaymentLatestDate +
                    ", firstPeriodRent=" + firstPeriodRent +
